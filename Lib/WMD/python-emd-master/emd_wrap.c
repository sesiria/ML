...
#define SWIGTYPE_p_f_p_feature_t_p_feature_t__float swig_types[1]
#define SWIGTYPE_p_signature_t swig_types[2]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__emd

#else
#  define SWIG_init    init_emd

#endif
#define SWIG_name    "_emd"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_emd(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  signature_t *arg1 = (signature_t *) 0 ;
  signature_t *arg2 = (signature_t *) 0 ;
  float (*arg3)(feature_t *,feature_t *) = (float (*)(feature_t *,feature_t *)) 0 ;
  PyObject *swig_obj[3] ;
  float result;
  
  if (!SWIG_Python_UnpackTuple(args, "emd", 3, 3, swig_obj)) SWIG_fail;
  {
    int i,j;
    
    // Start the tedious type checking (on swig_obj[0]):
    // Is it a tuple?
    ...
    Py_ssize_t tuple_size = PyTuple_Size(swig_obj[0]);
    if (tuple_size != 2) {
      PyErr_SetString(PyExc_TypeError,
        "expected a tuple of size two (features,weights)");
      return NULL;
    ...
    PyObject *features = PyTuple_GetItem(swig_obj[0],0);
    PyObject *weights = PyTuple_GetItem(swig_obj[0],1);
    ...
    // (arg1 is a placeholder for the variable that receives the converted value.) 
    arg1 = (signature_t *) malloc(sizeof(signature_t));
    arg1->n = (int) features_count;
    arg1->Features = features_array;
    arg1->Weights = weights_array;
  }
  {
    int i,j;
    
    // Start the tedious type checking (on swig_obj[1]):
    // Is it a tuple?
    ...
    // Does it have length 2?
    Py_ssize_t tuple_size = PyTuple_Size(swig_obj[1]);
    if (tuple_size != 2) {
      PyErr_SetString(PyExc_TypeError,
        "expected a tuple of size two (features,weights)");
      return NULL;
    ...
    // Are the entries lists of the same length?
    PyObject *features = PyTuple_GetItem(swig_obj[1],0);
    PyObject *weights = PyTuple_GetItem(swig_obj[1],1);
    if (!PyList_Check(features)) {
      PyErr_SetString(PyExc_TypeError, "first entry (features) must be a list");
      return NULL;
    }
    ...
    // Finally, create and return the (pointer to) the signature_t structure.
    // (arg2 is a placeholder for the variable that receives the converted value.) 
    arg2 = (signature_t *) malloc(sizeof(signature_t));
    arg2->n = (int) features_count;
    arg2->Features = features_array;
    arg2->Weights = weights_array;
  }
  {
    PyObject *new_distance_callback = swig_obj[2];
    ...
    arg3 = &distance_from_callback;
  }
  result = (float)emd_wrap(arg1,arg2,arg3);
  resultobj = SWIG_From_float((float)(result));
  {
    if (arg1 != NULL) {
      free((PyObject **) arg1->Features);
      free((float *) arg1->Weights);
      free((signature_t *) arg1);
    }
  }
  {
    if (arg2 != NULL) {
      free((PyObject **) arg2->Features);
      free((float *) arg2->Weights);
      free((signature_t *) arg2);
    }
  }
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "emd", _wrap_emd, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_f_p_feature_t_p_feature_t__float = {"_p_f_p_feature_t_p_feature_t__float", "float (*)(feature_t *,feature_t *)", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_signature_t = {"_p_signature_t", "signature_t *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_char,
  &_swigt__p_f_p_feature_t_p_feature_t__float,
  &_swigt__p_signature_t,
};

static swig_cast_info _swigc__p_char[] = {  {&_swigt__p_char, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_f_p_feature_t_p_feature_t__float[] = {  {&_swigt__p_f_p_feature_t_p_feature_t__float, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_signature_t[] = {  {&_swigt__p_signature_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_char,
  _swigc__p_f_p_feature_t_p_feature_t__float,
  _swigc__p_signature_t,
};
