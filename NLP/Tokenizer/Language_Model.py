#!/bin/env python
# original from https://github.com/joshualoehr/ngram-language-model/blob/master/language_model.py
import argparse
...
class LanguageModel(object):
    ...
    def getScore(self, ngram):
        """Calculate the score of the input ngram tuple or list.
        ...
        known_ngrams = self._convert_oov(ngram)
        return - math.log(self.model[known_ngrams])
